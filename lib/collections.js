...
PersonalTest = {    
    ...
    "questions": [
        { "type": 0, "q": "勤奮、忠誠、可靠,渴求安全感,做人做事都很認真。循法守規,有責任感,做事十分謹慎,凡事都計劃周詳。" },
        { "type": 0, "q": "有時善良溫順,有時焦躁易怒,令人難以捉摸。" },
        { "type": 0, "q": "不輕易相信別人,寧可與人保持距離,但內心又渴望得到別人的認同和欣賞。很在意伴侶對自己的想法,並會懷疑伴侶是否忠誠。" },
        { "type": 0, "q": "理財謹慎,會控制伴侶的財政和開支,但卻捨得花費在自己的愛好和興趣上。" },
        { "type": 0, "q": "性格矛盾,時而崇拜權威,時而反抗權威。經常猶豫不決,難下決定。處事方法極端,不是向前衝,就是拖延搖擺。多疑、警覺性高,有時會反應過敏,凡事都作最壞打算。" },
        { "type": 0, "q": "很難承認過失和原諒別人,對於別人的批評,我認為是一種惡意的攻擊。" },
